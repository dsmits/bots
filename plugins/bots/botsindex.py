...
plugins = [
    ...
    {'plugintype': 'translate', 'active': True, 'alt': '', 'desc': '', 'fromeditype': 'x12',
     'frommessagetype': '940004010', 'frompartner': None, 'rsrv1': None, 'rsrv2': None, 'toeditype': 'json',
    ...
    {'plugintype': 'routes', 'active': False, 'alt': '', 'defer': False, 'desc': '', 'fromchannel': 'x12_2_json_in',
     'fromeditype': 'x12', 'frommessagetype': '940004010', 'frompartner': None, 'frompartner_tochannel': None,
